...
// ApplyRawCommit mirrors ApplyCommit's CAS and branch-switch dance (see
...
// belong to Knowledge, and a RawFileStore write does not claim to be one.
func (r *FileGitRepository) ApplyRawCommit(cs repository.RawFileChangeSet) (kernel.CommitID, error) {
