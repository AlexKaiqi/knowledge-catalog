...
// Repository is a Gitea-hosted SnapshotStore + Knowledge. No worktree, no RootDir.
...
var (
	...
	_ repository.SnapshotStore = (*Repository)(nil)
	_ repository.Knowledge     = (*Repository)(nil)
)
