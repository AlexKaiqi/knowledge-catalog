...
var _ repository.RawFileStore = (*Repository)(nil)
...
// ApplyRawCommit mirrors ApplyCommit's wip-branch dance (commit.go) but skips
...
// as one that is.
func (r *Repository) ApplyRawCommit(cs repository.RawFileChangeSet) (kernel.CommitID, error) {
	...
	name, email, msg := commitSignature(repository.CommitChangeSet{
