...
var cliSurface = map[string]commandSurface{
	...
	"catalog repo list":              {"catalog-repositories", "catalog.read"},
	"catalog repo register":          {"register", "catalog.repositories.manage"},
	"catalog repo archive":           {"archive-repo", "catalog.repositories.manage"},
	"workspace list":                 {"catalog-workspaces", "catalog.read"},
	"workspace show":                 {"catalog-workspace", "catalog.read"},
	"workspace define":               {"define-workspace", "workspace.manage"},
	"workspace retire":               {"retire-workspace", "workspace.manage"},
	"workspace pin":                  {"resolve", "workspace.resolve"},
	"workspace check":                {"check-workspace", "workspace.resolve"},
	...
	"knowledge schema list":          {"browse-schemas", "knowledge.schema.read"},
	"knowledge binding show":         {"resolve-binding", "knowledge.binding.resolve"},
	"knowledge access":               {"resource-access", "resource.access"},
	"pack":                           {"ingest", "writer.preview"},
	...
	"operations projection notice":   {"index-notify", "projection.manage"},
	"operations access-spec describe": {"describe-access", "knowledge.access.describe"},
