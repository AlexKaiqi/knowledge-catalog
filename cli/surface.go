...
var cliSurface = map[string]commandSurface{
	...
	"workspace overlay":               {"workspace-overlay", "workspace.overlay"},
	"catalog repo attach":             {"catalog-repo-attach", "catalog.repositories.manage"},
	"catalog repo create":             {"catalog-repo-create", "catalog.repositories.create"},
	"catalog repo connect":            {"catalog-repo-connect", "catalog.repositories.connect"},
	"catalog repo connection show":    {"catalog-repo-connection-show", "repository.connections.manage"},
	"catalog repo connection check":   {"catalog-repo-connection-check", "repository.connections.manage"},
	"catalog repo connection rotate":  {"catalog-repo-connection-rotate", "repository.connections.manage"},
	...
	"admission request":               {"admission-request", "identity.admission.request"},
	"catalog repo share add":          {"catalog-repo-share-add", "repository.shares.manage"},
	"catalog repo share list":         {"catalog-repo-share-list", "repository.shares.manage"},
	"catalog repo share remove":       {"catalog-repo-share-remove", "repository.shares.manage"},
